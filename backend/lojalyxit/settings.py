...
INSTALLED_APPS = [
    ...
    'whitenoise.runserver_nostatic',  # doit précéder django.contrib.staticfiles
...
WSGI_APPLICATION = 'lojalyxit.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.environ.get('POSTGRES_DB', 'lojalyxit'),
        'USER': os.environ.get('POSTGRES_USER', 'lojalyxit'),
...
# WhiteNoise — compression + cache long terme pour les assets avec hash
STORAGES = {
    'default': {
